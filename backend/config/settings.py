...
# Base de datos: MySQL en local (XAMPP) / SQLite en el hosting gratuito
# (PythonAnywhere free no permite conexiones salientes a MySQL externo).
# Se controla con DB_ENGINE en el .env: "mysql" (default) o "sqlite".
